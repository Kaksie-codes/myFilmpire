            ...
            <div className={`container ${toggled === 'tab-1' ? 'show' : ''}`} id="tab-1-content">
                <div  className="tab-content-item">
                    <div className="tab-1-content-inner">
                        <div>
                            <h3>
                                If you decide Filmpire isn't for you - no problem. No commitment. Cancel Online anytime.
                            </h3>
                ...
                <div  className="tab-content-item">
                    ...
                    <div className="tab-2-content-bottom">
                        ...
                        <div>
                            ...
                            <p className="text-dark">Watch right on Filmpire.com.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className={`container ${toggled === 'tab-3' ? 'show' : ''}`} id="tab-3-content">                
                <div className="tab-content-item">
                    <div className="text-center">
                        <h3>
                            Choose one plan and watch everything on Filmpire.
                        </h3>
                        <a href="#" className="btn btn-lg">Watch Free For 30 Days</a>
                    </div>
